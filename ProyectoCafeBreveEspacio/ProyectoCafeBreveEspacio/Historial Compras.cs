...
namespace ProyectoCafeBreveEspacio
{
    public partial class Historial_Compras : Form
    {
        ...
        {
            c.cargar_historial_pagos(tablaCortes);
            txtAño.Focus();
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            {
                c.buscar_historial_año_pago(txtAño.Text, tablaCortes);
            }
            else if (txtAño.Text.Length <= 0 && cbxDia.Text.Length <= 0)
            {
                meses = mes(cbxMes.Text);
                c.buscar_historial_mes_pago(meses, tablaCortes);
            }
            else if (cbxDia.Text.Length <= 0)
            {
                meses = mes(cbxMes.Text);
                c.buscar_hidtorial_añoymes_pago(txtAño.Text, meses, tablaCortes);
            }
            else
            {
                meses = mes(cbxMes.Text);
                ...
                c.buscar_historial_pago(txtAño.Text, meses, dias, tablaCortes);
            }
        }
